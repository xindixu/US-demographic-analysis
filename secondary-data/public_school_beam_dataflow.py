...
def run():
    ...
    google_cloud_options.job_name = 'public-school-df'
    ...
    sql = 'SELECT * FROM edge_1718_modeled.public_school'
    ...
    query_results | 'Record original data' >> WriteToText(DIR_PATH +
                                                          'public_school_Beam_DF_input.txt')
    ...
    formated_pcoll | 'Record processed data' >> WriteToText(DIR_PATH +
                                                            'public_school_Beam_DF_output.txt')

    dataset_id = 'edge_1718_modeled'
    table_id = 'public_school_Beam_DF'

...
def run():
    ...
    google_cloud_options.job_name = 'postsecondary-school-df'
    ...
    sql = 'SELECT * FROM edge_1718_modeled.postsecondary_school'
    ...
    query_results | 'Record original data' >> WriteToText(DIR_PATH +
                                                          'postsecondary_school_Beam_DF_input.txt')
    ...
    formated_pcoll | 'Record processed data' >> WriteToText(DIR_PATH +
                                                            'postsecondary_school_Beam_DF_output.txt')

    dataset_id = 'edge_1718_modeled'
    table_id = 'postsecondary_school_Beam_DF'

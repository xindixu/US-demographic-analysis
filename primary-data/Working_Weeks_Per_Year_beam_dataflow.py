...
def run():
    ...
    sql = 'SELECT * FROM acs_2018_modeled.Working_Weeks_Per_Year'
    ...
    query_results | 'Record original data' >> WriteToText(DIR_PATH +
                                                          'Working_Weeks_Per_Year_Beam_DF_input.txt')
    ...
    formated_pcoll | 'Record processed data' >> WriteToText(DIR_PATH +
                                                             'Working_Weeks_Per_Year_Beam_DF_output.txt')

    dataset_id = 'acs_2018_modeled'
    table_id = 'Working_Weeks_Per_Year_Beam_DF'
